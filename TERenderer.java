...
public class TERenderer {
    ...
    public void renderFrame(TETile[][] world, Avatar avatar) {
        int xCoordinates = avatar.getxCoordinate();
        int ycoordinates = avatar.getyCoordinate();
        int numCandles = avatar.getNumKey();
        int light = (numCandles + 1) * 4;
        ...
        for (int x = 0; x < numXTiles; x += 1) {
            for (int y = 0; y < numYTiles; y += 1) {
                ...
                if (x < xCoordinates - light || x > xCoordinates + light
                ||  y < ycoordinates - light || y > ycoordinates + light) {
